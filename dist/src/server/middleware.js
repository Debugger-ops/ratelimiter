export function defaultIdentify(req) {
...
export function rateLimit(deps, opts = {}) {
...
function applyHeaders(res, d) {
    ...
    res.setHeader('RateLimit-Policy', `${d.quota};w=${Math.round(d.windowMs / 1000)};burst=${d.limit};policy="${d.policy}"`);
